...
## User request
Review authentication, RBAC documentation, API secrets handling, and personal-data retention.
...
## Execution sequence
1. Review supplied security and privacy evidence.
2. Separate confirmed risks, assumptions, and missing evidence.
3. Recommend defensive remediation and verification.
